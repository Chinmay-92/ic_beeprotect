...
import beeprotect.de.beeprotect.*

class ESPBLE : AppCompatActivity(), OnDeviceScanListener, View.OnClickListener {
    ...
    private var mDeviceAddress: String = "CC:50:E3:99:13:D6"// "CC:50:E3:99:13:D6"
    ...
    private fun initBLEModule() {
        ...
        BLEConnectionManager.initBLEService(this@ESPBLE)
    }
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            when {
                BLEConstants.ACTION_GATT_CONNECTED.equals(action) -> {
                    ...
                    BLEConnectionManager.findBLEGattService(this@ESPBLE)
                }
    ...
    private fun connectDevice() {
        Handler().postDelayed({
            ...
            if (BLEConnectionManager.connect(mDeviceAddress)) {
                Toast.makeText(this@ESPBLE, "DEVICE CONNECTED", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@ESPBLE, "DEVICE CONNECTION FAILED", Toast.LENGTH_SHORT).show()
            }
        }, 100)
    }
