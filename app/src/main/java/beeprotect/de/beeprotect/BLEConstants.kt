...
class BLEConstants {
    ...
    companion object {
        ...
        const val LE_DATA_PRIVATE_CHAR = "fddbffd7-98b6-4898-b7d7-c6afe982e728" //"75748f1d-daef-4fc1-b602-51c17c9d49c2" //Characteristic for MLDP Data, properties - notify, write

        const val CHARACTERISTIC_DEVICE_NAME = "ESP32"    //Special UUID for get the device Name
